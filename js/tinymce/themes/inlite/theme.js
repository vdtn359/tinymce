...
var inlite = (function () {
  ...
  var $_a773t716ijdxo79e8 = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_fbnv3s16mjdxo79eh.fromClientRect(clientRect)) : null;
  };
  var $_4wfmce16ljdxo79ee = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          return $_e41d6u16kjdxo79ec.result(predicateIds[i].id, $_4wfmce16ljdxo79ee.getElementRect(editor, element));
        }
      }
      return null;
    };
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_e41d6u16kjdxo79ec.result(predicateIds[x].id, $_4wfmce16ljdxo79ee.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        return $_e41d6u16kjdxo79ec.result(id, $_4wfmce16ljdxo79ee.getSelectionRect(editor));
      }
      return null;
    };
  };
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_bkbbce16vjdxo79fq.isArray(value)) {
      return value;
    } else if ($_bkbbce16vjdxo79fq.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_bkbbce16vjdxo79fq.isBoolean(value)) {
  ...
  var $_3hqbi16ujdxo79fm = {
    getStringOr: getByTypeOr($_bkbbce16vjdxo79fq.isString),
    getBoolOr: getByTypeOr($_bkbbce16vjdxo79fq.isBoolean),
    getNumberOr: getByTypeOr($_bkbbce16vjdxo79fq.isNumber),
    getHandlerOr: getByTypeOr($_bkbbce16vjdxo79fq.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_bkbbce16vjdxo79fq.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_fbnv3s16mjdxo79eh.toClientRect(targetRect),
        contentAreaRect: $_fbnv3s16mjdxo79eh.toClientRect(contentAreaRect),
        panelRect: $_fbnv3s16mjdxo79eh.toClientRect(panelRect)
      });
      return $_fbnv3s16mjdxo79eh.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_3hqbi16ujdxo79fm.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_3hqbi16ujdxo79fm.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_3hqbi16ujdxo79fm.getHandlerOr(editor, 'inline_toolbar_position_handler', $_461i8l16wjdxo79ft.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_dlgpz716rjdxo79eq.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_la4p016sjdxo79eu.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_la4p016sjdxo79eu.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_au77cl16qjdxo79eo = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_a773t716ijdxo79e8.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_ygyp616njdxo79ej.fromContextToolbars(toolbars);
    result = $_e41d6u16kjdxo79ec.match(editor, [
      $_clrx5616jjdxo79ea.element(elements[0], contextToolbarsPredicateIds),
      $_1fp87816pjdxo79em.textSelection('text'),
      $_1fp87816pjdxo79em.emptyTextBlock(elements, 'insert'),
      $_clrx5616jjdxo79ea.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_e41d6u16kjdxo79ec.match(editor, [$_1fp87816pjdxo79em.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_au77cl16qjdxo79eo.load(editor, function () {
  ...
  var $_86967z16ejdxo79e0 = { renderUI: renderUI };
  ...
  var never$1 = $_y4f5c171jdxo79gf.never;
  var always$1 = $_y4f5c171jdxo79gf.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_y4f5c171jdxo79gf.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_2ci4n8178jdxo79hf.parseBox(settings.border);
      self.paddingBox = $_2ci4n8178jdxo79hf.parseBox(settings.padding);
      self.marginBox = $_2ci4n8178jdxo79hf.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_5emgcn17gjdxo79ih.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_2ci4n8178jdxo79hf.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_2ci4n8178jdxo79hf.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_2ci4n8178jdxo79hf.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_1j2fut17fjdxo79if.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_5emgcn17gjdxo79ih.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var $_9iv5rc17hjdxo79il = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_5emgcn17gjdxo79ih.getUiContainer(self);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_5emgcn17gjdxo79ih.inheritUiContainer(this, this._tooltip);
  ...
  function NotificationManagerImpl (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_6pkg1x16zjdxo79g3.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_6pkg1x16zjdxo79g3.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_2ci4n8178jdxo79hf.parseBox(self.settings.border);
          ...
          self.borderBox = $_2ci4n8178jdxo79hf.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_86967z16ejdxo79e0.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_4pmbi116djdxo79dw = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_5s0low180jdxo79ks.resolve(name, scope);
  };
  ...
  var $_96vlxt17zjdxo79kp = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_96vlxt17zjdxo79kp.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_16ac4617xjdxo79kk = { blobToBase64: blobToBase64 };
  ...
  var $_8ibcfr183jdxo79kw = { pickFile: pickFile };
  ...
  var $_6h6znr185jdxo79l2 = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_focgzm187jdxo79l7.create(dom, selection.getRng());
    Tools.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_focgzm187jdxo79l7.resolve(dom, bookmark));
  };
  ...
  var $_3bbhfz186jdxo79l4 = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_6h6znr185jdxo79l2.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_3bbhfz186jdxo79l4.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_302m1s184jdxo79kz.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_8ibcfr183jdxo79kw.pickFile().then(function (files) {
          var blob = files[0];
          $_16ac4617xjdxo79kk.blobToBase64(blob).then(function (base64) {
            $_302m1s184jdxo79kz.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_302m1s184jdxo79kz.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_2tton517wjdxo79ki = { addToEditor: addToEditor };
  ...
  var $_c425to18bjdxo79lj = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_1m3uvw18djdxo79ly.isAbsolute(href) && $_1m3uvw18djdxo79ly.isDomainLike(href) ? askAboutPrefix(editor, href) : Promise.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_302m1s184jdxo79kz.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_302m1s184jdxo79kz.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_3l3xrw18cjdxo79lo = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_bkbbce16vjdxo79fq.isArray(items)) {
      return items;
    } else if ($_bkbbce16vjdxo79fq.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
  ...
  var $_8ycqw618ejdxo79m0 = { create: create$2 };

  function Panel$1 () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return Tools.map(toolbars, function (toolbar) {
        return $_8ycqw618ejdxo79m0.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_8ycqw618ejdxo79m0.create(editor, 'text', $_la4p016sjdxo79eu.getTextSelectionToolbarItems(editor)),
        $_8ycqw618ejdxo79m0.create(editor, 'insert', $_la4p016sjdxo79eu.getInsertToolbarItems(editor)),
        $_3l3xrw18cjdxo79lo.createQuickLinkForm(editor, hide)
      ]);
      return Factory.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_la4p016sjdxo79eu.getPositionHandler(editor);
      contentAreaRect = $_4wfmce16ljdxo79ee.getContentAreaRect(editor);
      panelRect = DOMUtils.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_461i8l16wjdxo79ft.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_461i8l16wjdxo79ft.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_c425to18bjdxo79lj.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_461i8l16wjdxo79ft.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_4wfmce16ljdxo79ee.getContentAreaRect(editor);
        panelRect = DOMUtils.DOM.getRect(panel.getEl());
        result = $_461i8l16wjdxo79ft.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_461i8l16wjdxo79ft.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_dlgpz716rjdxo79eq.fireBeforeRenderUI(editor);
  ...
  var $_f56tyl191jdxo79o4 = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_y4f5c171jdxo79gf.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return Option.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_143cmv192jdxo79o6 = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_1vmwuf196jdxo79oi = { cached: cached };

  var $_1jwywe198jdxo79ol = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_1jwywe198jdxo79ol.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_1jwywe198jdxo79ol.ELEMENT);
  var isText = isType$1($_1jwywe198jdxo79ol.TEXT);
  var isDocument = isType$1($_1jwywe198jdxo79ol.DOCUMENT);
  var $_c8p9dx197jdxo79ok = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_c8p9dx197jdxo79ok.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_1vmwuf196jdxo79oi.cached(function () {
    return getBody($_143cmv192jdxo79o6.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_143cmv192jdxo79o6.fromDom(body);
  };
  var $_2wf8og195jdxo79of = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  function Immutable () {
    ...
    return function () {
      ...
      var struct = {};
      $_6pkg1x16zjdxo79g3.each(fields, function (name, i) {
        struct[name] = $_y4f5c171jdxo79gf.constant(values[i]);
      });
      return struct;
    };
  }
  ...
  var validateStrArr = function (label, array) {
    if (!$_c1mhlm19ajdxo79ox.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_6pkg1x16zjdxo79g3.each(array, function (a) {
      if (!$_c1mhlm19ajdxo79ox.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_6pkg1x16zjdxo79g3.find(sorted, function (s, i) {
  ...
  function MixedBag (required, optional) {
    ...
    $_eux0ej19fjdxo79p9.validateStrArr('required', required);
    $_eux0ej19fjdxo79p9.validateStrArr('optional', optional);
    $_eux0ej19fjdxo79p9.checkDupes(everything);
    return function (obj) {
      var keys = $_46uauw19ejdxo79p5.keys(obj);
      var allReqd = $_6pkg1x16zjdxo79g3.forall(required, function (req) {
        return $_6pkg1x16zjdxo79g3.contains(keys, req);
      });
      if (!allReqd)
        $_eux0ej19fjdxo79p9.reqMessage(required, keys);
      var unsupported = $_6pkg1x16zjdxo79g3.filter(keys, function (key) {
        return !$_6pkg1x16zjdxo79g3.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_eux0ej19fjdxo79p9.unsuppMessage(unsupported);
      var r = {};
      $_6pkg1x16zjdxo79g3.each(required, function (req) {
        r[req] = $_y4f5c171jdxo79gf.constant(obj[req]);
      });
      $_6pkg1x16zjdxo79g3.each(optional, function (opt) {
        r[opt] = $_y4f5c171jdxo79gf.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? Option.some(obj[opt]) : Option.none());
      });
      return r;
    };
  }

  var $_78of4f19bjdxo79oz = {
    immutable: Immutable,
  ...
  var $_2108uo19gjdxo79pc = { toArray: toArray };

  var node = function () {
    var f = $_96vlxt17zjdxo79kp.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_4mhhr619mjdxo79q3.unknown()
    });
  };
  ...
  var $_5e497f19ljdxo79pz = {
    unknown: unknown$1,
    nu: nu$1,
    edge: $_y4f5c171jdxo79gf.constant(edge),
    chrome: $_y4f5c171jdxo79gf.constant(chrome),
    ie: $_y4f5c171jdxo79gf.constant(ie),
    opera: $_y4f5c171jdxo79gf.constant(opera),
    firefox: $_y4f5c171jdxo79gf.constant(firefox),
    safari: $_y4f5c171jdxo79gf.constant(safari)
  };
  ...
  var $_9vjp3419njdxo79q5 = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_y4f5c171jdxo79gf.constant(windows$1),
    ios: $_y4f5c171jdxo79gf.constant(ios),
    android: $_y4f5c171jdxo79gf.constant(android),
    linux: $_y4f5c171jdxo79gf.constant(linux),
    osx: $_y4f5c171jdxo79gf.constant(osx),
    solaris: $_y4f5c171jdxo79gf.constant(solaris),
    freebsd: $_y4f5c171jdxo79gf.constant(freebsd)
  };
  ...
  function DeviceType (os, browser, userAgent) {
    ...
    return {
      isiPad: $_y4f5c171jdxo79gf.constant(isiPad),
      isiPhone: $_y4f5c171jdxo79gf.constant(isiPhone),
      isTablet: $_y4f5c171jdxo79gf.constant(isTablet),
      isPhone: $_y4f5c171jdxo79gf.constant(isPhone),
      isTouch: $_y4f5c171jdxo79gf.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_y4f5c171jdxo79gf.constant(iOSwebview)
    };
  }

  var detect$1 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_6pkg1x16zjdxo79g3.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_4mhhr619mjdxo79q3.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_4mhhr619mjdxo79q3.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_4x09mf19sjdxo79qq.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_4x09mf19sjdxo79qq.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_4x09mf19sjdxo79qq.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_4x09mf19sjdxo79qq.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_4zl53d19tjdxo79qr.head(str).bind(function (head) {
      return $_4zl53d19tjdxo79qr.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_dkron119rjdxo79qn.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_dkron119rjdxo79qn.contains(uastring, 'edge/') && $_dkron119rjdxo79qn.contains(uastring, 'chrome') && $_dkron119rjdxo79qn.contains(uastring, 'safari') && $_dkron119rjdxo79qn.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_dkron119rjdxo79qn.contains(uastring, 'chrome') && !$_dkron119rjdxo79qn.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_dkron119rjdxo79qn.contains(uastring, 'msie') || $_dkron119rjdxo79qn.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_dkron119rjdxo79qn.contains(uastring, 'safari') || $_dkron119rjdxo79qn.contains(uastring, 'mobile/')) && $_dkron119rjdxo79qn.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_dkron119rjdxo79qn.contains(uastring, 'iphone') || $_dkron119rjdxo79qn.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_eldge119qjdxo79qh = {
    browsers: $_y4f5c171jdxo79gf.constant(browsers),
    oses: $_y4f5c171jdxo79gf.constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_eldge119qjdxo79qh.browsers();
    var oses = $_eldge119qjdxo79qh.oses();
    var browser = $_848mrg19pjdxo79qd.detectBrowser(browsers, userAgent).fold($_5e497f19ljdxo79pz.unknown, $_5e497f19ljdxo79pz.nu);
    var os = $_848mrg19pjdxo79qd.detectOs(oses, userAgent).fold($_9vjp3419njdxo79q5.unknown, $_9vjp3419njdxo79q5.nu);
  ...
  var $_cu30mq19kjdxo79py = { detect: detect$2 };

  var detect$3 = $_1vmwuf196jdxo79oi.cached(function () {
    var userAgent = navigator.userAgent;
    return $_cu30mq19kjdxo79py.detect(userAgent);
  });
  var $_20nmpl19jjdxo79pu = { detect: detect$3 };

  var ELEMENT = $_1jwywe198jdxo79ol.ELEMENT;
  var DOCUMENT = $_1jwywe198jdxo79ol.DOCUMENT;
  ...
  var all = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_6pkg1x16zjdxo79g3.map(base.querySelectorAll(selector), $_143cmv192jdxo79o6.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? Option.none() : Option.from(base.querySelector(selector)).map($_143cmv192jdxo79o6.fromDom);
  };
  var $_cgc41n19ujdxo79qt = {
    all: all,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_6pkg1x16zjdxo79g3.exists(elements, $_y4f5c171jdxo79gf.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_7uedr19ijdxo79pt.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_20nmpl19jjdxo79pu.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_atejkx19hjdxo79pd = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_cgc41n19ujdxo79qt.is
  };

  var owner = function (element) {
    return $_143cmv192jdxo79o6.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_143cmv192jdxo79o6.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_143cmv192jdxo79o6.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return Option.from(dom.parentNode).map($_143cmv192jdxo79o6.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children(p);
      return $_6pkg1x16zjdxo79g3.findIndex(kin, function (elem) {
        return $_atejkx19hjdxo79pd.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_c1mhlm19ajdxo79ox.isFunction(isRoot) ? isRoot : $_y4f5c171jdxo79gf.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_143cmv192jdxo79o6.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return $_6pkg1x16zjdxo79g3.filter(elements, function (x) {
        return !$_atejkx19hjdxo79pd.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return Option.from(dom.offsetParent).map($_143cmv192jdxo79o6.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.previousSibling).map($_143cmv192jdxo79o6.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.nextSibling).map($_143cmv192jdxo79o6.fromDom);
  };
  var prevSiblings = function (element) {
    return $_6pkg1x16zjdxo79g3.reverse($_2108uo19gjdxo79pc.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_2108uo19gjdxo79pc.toArray(element, nextSibling);
  };
  var children = function (element) {
    var dom = element.dom();
    return $_6pkg1x16zjdxo79g3.map(dom.childNodes, $_143cmv192jdxo79o6.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return Option.from(children[index]).map($_143cmv192jdxo79o6.fromDom);
  };
  ...
  var spot = $_78of4f19bjdxo79oz.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_2a0am1199jdxo79on = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants($_2wf8og195jdxo79of.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return $_6pkg1x16zjdxo79g3.filter($_2a0am1199jdxo79on.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_6pkg1x16zjdxo79g3.filter($_2a0am1199jdxo79on.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_6pkg1x16zjdxo79g3.filter($_2a0am1199jdxo79on.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    $_6pkg1x16zjdxo79g3.each($_2a0am1199jdxo79on.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_cgc41n19ujdxo79qt.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_216sf6194jdxo79oc.ancestors(scope, function (e) {
      return $_cgc41n19ujdxo79qt.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_216sf6194jdxo79oc.siblings(scope, function (e) {
      return $_cgc41n19ujdxo79qt.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_216sf6194jdxo79oc.children(scope, function (e) {
      return $_cgc41n19ujdxo79qt.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_cgc41n19ujdxo79qt.all(selector, scope);
  };
  var $_1cdacp193jdxo79ob = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return $_6pkg1x16zjdxo79g3.map($_1cdacp193jdxo79ob.descendants($_143cmv192jdxo79o6.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_f56tyl191jdxo79o4.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$3('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_y4f5c171jdxo79gf.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_6pkg1x16zjdxo79g3.map($_6pkg1x16zjdxo79g3.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_6pkg1x16zjdxo79g3.map($_6pkg1x16zjdxo79g3.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$3 = function (elm) {
    ...
    return $_6pkg1x16zjdxo79g3.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_1y8fp3190jdxo79nv = { find: find$3 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_y4f5c171jdxo79gf.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_6pkg1x16zjdxo79g3.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_6pkg1x16zjdxo79g3.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_6pkg1x16zjdxo79g3.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_6pkg1x16zjdxo79g3.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_6pkg1x16zjdxo79g3.indexOf(items, url) === -1) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_1y8fp3190jdxo79nv.find(bodyElm);
  ...
  function ClosestOrAncestor (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? Option.some(scope) : $_c1mhlm19ajdxo79ox.isFunction(isRoot) && isRoot(scope) ? Option.none() : ancestor(scope, a, isRoot);
  }

  var first$1 = function (predicate) {
    return descendant($_2wf8og195jdxo79of.body(), predicate);
  };
  var ancestor = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_143cmv192jdxo79o6.fromDom(element);
      if (predicate(el))
  ...
  var sibling = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return Option.none();
    return child$1($_143cmv192jdxo79o6.fromDom(element.parentNode), function (x) {
      return !$_atejkx19hjdxo79pd.eq(scope, x) && predicate(x);
    });
  };
  var child$1 = function (scope, predicate) {
    var result = $_6pkg1x16zjdxo79g3.find(scope.dom().childNodes, $_y4f5c171jdxo79gf.compose(predicate, $_143cmv192jdxo79o6.fromDom));
    return result.map($_143cmv192jdxo79o6.fromDom);
  };
  var descendant = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_143cmv192jdxo79o6.fromDom(element.childNodes[i])))
          return Option.some($_143cmv192jdxo79o6.fromDom(element.childNodes[i]));
  ...
  var first$2 = function (selector) {
    return $_cgc41n19ujdxo79qt.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_3xvbgp1a0jdxo79rh.ancestor(scope, function (e) {
      return $_cgc41n19ujdxo79qt.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_3xvbgp1a0jdxo79rh.sibling(scope, function (e) {
      return $_cgc41n19ujdxo79qt.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_3xvbgp1a0jdxo79rh.child(scope, function (e) {
      return $_cgc41n19ujdxo79qt.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_cgc41n19ujdxo79qt.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_cgc41n19ujdxo79qt.is, ancestor$1, scope, selector, isRoot);
  };
  var $_8k470719zjdxo79rf = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_78150y1a3jdxo79s3.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_78150y1a3jdxo79s3.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_78150y1a3jdxo79s3.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_78150y1a3jdxo79s3.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_78150y1a3jdxo79s3.postRenderFormat(editor, name)
      });
    });
  };
  var $_d6mp5u1a2jdxo79s1 = { register: register };
  ...
  var getFontProp = function (propName) {
    return function (rootElm, elm) {
      return Option.from(elm).map($_143cmv192jdxo79o6.fromDom).filter($_c8p9dx197jdxo79ok.isElement).bind(function (element) {
        return getSpecifiedFontProp(propName, rootElm, element.dom()).or(getComputedFontProp(propName, element.dom()));
      }).getOr('');
    };
  };
  var $_acymdv1a5jdxo79s8 = {
    getFontSize: getFontProp('fontSize'),
    getFontFamily: $_y4f5c171jdxo79gf.compose(normalizeFontFamily, getFontProp('fontFamily')),
    toPt: toPt
  };
  ...
  var createFontNameListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        var fontFamily = $_acymdv1a5jdxo79s8.getFontFamily(editor.getBody(), e.element);
  ...
  var $_6abvq61a4jdxo79s5 = { register: register$1 };
  ...
  var createFontSizeListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        ...
        px = $_acymdv1a5jdxo79s8.getFontSize(editor.getBody(), e.element);
        if (px) {
          for (precision = 3; !match && precision >= 0; precision--) {
            pt = $_acymdv1a5jdxo79s8.toPt(px, precision);
  ...
  var $_d9d25w1a6jdxo79sg = { register: register$2 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_78150y1a3jdxo79s3.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_aks4lh1a7jdxo79sj = { register: register$3 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_78150y1a3jdxo79s3.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return Tools.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_78150y1a3jdxo79s3.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_5kyvlt1a8jdxo79sp = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_6pkg1x16zjdxo79g3.flatten(Tools.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_6pkg1x16zjdxo79g3.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_6pkg1x16zjdxo79g3.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_f3d1n41a9jdxo79ss = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_78150y1a3jdxo79s3.postRenderFormat(editor, name),
        onclick: $_78150y1a3jdxo79s3.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_78150y1a3jdxo79s3.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_98nrdf1aajdxo79sx = { register: register$6 };
  ...
  var $_sj3dm1abjdxo79t0 = { register: register$7 };
  ...
  var $_52ze5o1acjdxo79t2 = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      Env.container = $_8k470719zjdxo79rf.descendant($_143cmv192jdxo79o6.fromDom(document.body), editor.settings.ui_container).fold($_y4f5c171jdxo79gf.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_5kyvlt1a8jdxo79sp.register(editor);
    $_d6mp5u1a2jdxo79s1.register(editor);
    $_98nrdf1aajdxo79sx.register(editor);
    $_sj3dm1abjdxo79t0.register(editor);
    $_d9d25w1a6jdxo79sg.register(editor);
    $_6abvq61a4jdxo79s5.register(editor);
    $_aks4lh1a7jdxo79sj.register(editor);
    $_52ze5o1acjdxo79t2.register(editor);
    $_f3d1n41a9jdxo79ss.register(editor);
  };
  var $_3n9hs19yjdxo79r9 = { setup: setup };
  ...
  var Slider = Widget.extend({
    init: function (settings) {
      ...
      self._minValue = $_c1mhlm19ajdxo79ox.isNumber(settings.minValue) ? settings.minValue : 0;
      self._maxValue = $_c1mhlm19ajdxo79ox.isNumber(settings.maxValue) ? settings.maxValue : 100;
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_1j2fut17fjdxo79if,
      Control: Control$1,
      Factory: Factory,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_5eerce17tjdxo79k7,
      Panel: Panel,
      Movable: $_9iv5rc17hjdxo79il,
      Resizable: $_awjqri17ujdxo79kb,
      ...
      FormatControls: $_3n9hs19yjdxo79r9,
  ...
  ThemeManager.add('inlite', function (editor) {
    var panel = Panel$1();
    $_3n9hs19yjdxo79r9.setup(editor);
    $_2tton517wjdxo79ki.addToEditor(editor, panel);
    return $_4pmbi116djdxo79dw.get(editor, panel);
  });
  function Theme () {
  }
