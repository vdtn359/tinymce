...
var tabfocus = (function () {
  ...
  var $_6lmpbvjmjdxo72om = { getTabFocus: getTabFocus };
  ...
  var setup = function (editor) {
    function tabHandler(e) {
      ...
      v = Tools.explode($_6lmpbvjmjdxo72om.getTabFocus(editor));
      if (v.length === 1) {
        v[1] = v[0];
        v[0] = ':prev';
      }
  ...
  var $_atwj11jfjdxo72oc = { setup: setup };

  PluginManager.add('tabfocus', function (editor) {
    $_atwj11jfjdxo72oc.setup(editor);
  });
  function Plugin () {
  }
