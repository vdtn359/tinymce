...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_2wtazx8cjdxo6zsh.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_2wtazx8cjdxo6zsh.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_2wtazx8cjdxo6zsh.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_2wtazx8cjdxo6zsh.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_2wtazx8cjdxo6zsh.getAutoResizeBottomMargin(editor);
    ...
    if ($_2wtazx8cjdxo6zsh.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_67rpha89jdxo6zs7.resize(editor, oldSize);
    });
  };
  var $_5dhkib88jdxo6zs3 = { register: register };

  PluginManager.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_5dhkib88jdxo6zs3.register(editor, oldSize);
      $_67rpha89jdxo6zs7.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
