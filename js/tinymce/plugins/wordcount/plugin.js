...
var wordcount = (function () {
  ...
  var $_cm0r87s4jdxo753w = {
    each: each,
    map: map
  };

  var SETS$1 = $_30b79gs2jdxo753o.SETS;
  var OTHER = $_30b79gs2jdxo753o.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_cm0r87s4jdxo753w.map(string.split(''), memoized);
  };
  var $_fs50i8s3jdxo753r = { classify: classify };

  var ci = $_30b79gs2jdxo753o.characterIndices;
  ...
  var $_2my8zas5jdxo754e = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_30b79gs2jdxo753o.EMPTY_STRING;
  var WHITESPACE$1 = $_30b79gs2jdxo753o.WHITESPACE;
  var PUNCTUATION$1 = $_30b79gs2jdxo753o.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_fs50i8s3jdxo753r.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_2my8zas5jdxo754e.isWordBoundary(map, i)) {
  ...
  var $_7uliuus1jdxo753k = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_7uliuus1jdxo753k.getWords(getTextContent(editor)).length;
  };
  var $_fy45zjs0jdxo753i = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_fy45zjs0jdxo753i.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_9wy2e6rzjdxo753g = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return I18n.translate([
        '{0} words',
        $_fy45zjs0jdxo753i.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_33l0tms6jdxo754j = { setup: setup };

  PluginManager.add('wordcount', function (editor) {
    $_33l0tms6jdxo754j.setup(editor);
    return $_9wy2e6rzjdxo753g.get(editor);
  });
  function Plugin () {
  }
