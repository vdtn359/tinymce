...
var textpattern = (function () {
  ...
  var $_dszbvaqhjdxo74q3 = { getPatterns: getPatterns };
  ...
  var patternFromRng = function (patterns, rng, space) {
    ...
    var endPattern = $_7e7ynqpjdxo74rk.findEndPattern(patterns, text, rng.startOffset, delta);
    ...
    var startPattern = $_7e7ynqpjdxo74rk.findPattern(patterns, patternRng.toString());
  ...
  var applyBlockFormat = function (editor, patterns) {
    ...
    if (textBlockElm) {
      ...
      if (firstTextNode) {
        pattern = $_7e7ynqpjdxo74rk.findPattern(patterns, firstTextNode.data);
        if (!pattern) {
          return;
        }
  ...
  function handleEnter(editor, patterns) {
    ...
    wrappedTextNode = $_8mwbbvqmjdxo74r8.applyInlineFormatEnter(editor, patterns);
    if (wrappedTextNode) {
    ...
    $_8mwbbvqmjdxo74r8.applyBlockFormat(editor, patterns);
  }
  function handleInlineKey(editor, patterns) {
    var wrappedTextNode, lastChar, lastCharNode, rng, dom;
    wrappedTextNode = $_8mwbbvqmjdxo74r8.applyInlineFormatSpace(editor, patterns);
    if (wrappedTextNode) {
      dom = editor.dom;
  ...
  var setup = function (editor, patternsState) {
    ...
    editor.on('keydown', function (e) {
      if (e.keyCode === 13 && !VK.modifierPressed(e)) {
        $_a2l2pdqljdxo74qm.handleEnter(editor, patternsState.get());
      }
    }, true);
    editor.on('keyup', function (e) {
      if ($_a2l2pdqljdxo74qm.checkKeyCode(keyCodes, e)) {
        $_a2l2pdqljdxo74qm.handleInlineKey(editor, patternsState.get());
      }
    });
    editor.on('keypress', function (e) {
      if ($_a2l2pdqljdxo74qm.checkCharCode(charCodes, e)) {
  ...
  var $_bxynw6qijdxo74q5 = { setup: setup };

  PluginManager.add('textpattern', function (editor) {
    var patternsState = Cell($_dszbvaqhjdxo74q3.getPatterns(editor.settings));
    $_bxynw6qijdxo74q5.setup(editor, patternsState);
    return $_cs8orfqgjdxo74q1.get(patternsState);
  });
  function Plugin () {
  }
