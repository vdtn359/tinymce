...
var contextmenu = (function () {
  ...
  var $_6qfhya2jdxo70b1 = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_52p257a1jdxo70ar.getContextMenu(editor);
  ...
  var $_7tr7o4a5jdxo70ba = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_52p257a1jdxo70ar.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_7tr7o4a5jdxo70ba.show(editor, $_6qfhya2jdxo70b1.getPos(editor, e), visibleState, menu);
    });
  };
  var $_83uonra0jdxo70am = { setup: setup };

  PluginManager.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_83uonra0jdxo70am.setup(editor, visibleState, menu);
    return $_bkw9ym9zjdxo70ak.get(visibleState);
  });
  function Plugin () {
  }
