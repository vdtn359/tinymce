...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_3xrpb19njdxo704r.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_5c4ef49jjdxo702m.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_2jh5789ljdxo702p.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_dvd8nd9ojdxo704u = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_2b35kg9ijdxo702g = {
    open: function (editor) {
      var minWidth = $_5c4ef49jjdxo702m.getDialogMinWidth(editor);
      var minHeight = $_5c4ef49jjdxo702m.getDialogMinHeight(editor);
      var currentLanguage = $_dvd8nd9ojdxo704u.getCurrentLanguage(editor);
      var currentLanguages = $_dvd8nd9ojdxo704u.getLanguages(editor);
      var currentCode = $_2jh5789ljdxo702p.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_2jh5789ljdxo702p.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_3xrpb19njdxo704r.isCodeSample(node)) {
        $_2b35kg9ijdxo702g.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_92cwjo9hjdxo702e = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_3xrpb19njdxo704r.trimArg($_3xrpb19njdxo704r.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_3xrpb19njdxo704r.trimArg($_3xrpb19njdxo704r.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_bxm3j29pjdxo704z = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_5c4ef49jjdxo702m.getContentCss(editor);
  ...
  var $_397thd9qjdxo7053 = { loadCss: loadCss };
  ...
  var $_cfm4u69rjdxo7059 = { register: register$1 };

  var addedInlineCss = Cell(false);
  PluginManager.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_bxm3j29pjdxo704z.setup(editor);
    $_cfm4u69rjdxo7059.register(editor);
    $_92cwjo9hjdxo702e.register(editor);
    editor.on('init', function () {
      $_397thd9qjdxo7053.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_3xrpb19njdxo704r.isCodeSample(ev.target)) {
        $_2b35kg9ijdxo702g.open(editor);
      }
    });
  });
