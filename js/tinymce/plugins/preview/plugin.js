...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_4znjski6jdxo72ad.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_4znjski6jdxo72ad.getPreviewDialogWidth(editor);
    var dialogHeight = $_4znjski6jdxo72ad.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_5che0yi7jdxo72af.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_3gl42ci4jdxo72a9 = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_3gl42ci4jdxo72a9.open(editor);
    });
  };
  var $_3how14i3jdxo72a5 = { register: register };
  ...
  var $_fru43vi9jdxo72as = { register: register$1 };

  PluginManager.add('preview', function (editor) {
    $_3how14i3jdxo72a5.register(editor);
    $_fru43vi9jdxo72as.register(editor);
  });
  function Plugin () {
  }
