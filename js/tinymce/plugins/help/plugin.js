...
var help = (function () {
  ...
  var never$1 = $_3v0esraqjdxo70gy.never;
  var always$1 = $_3v0esraqjdxo70gy.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_3v0esraqjdxo70gy.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var $_7ntxlzasjdxo70hf = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_1rk8u3aojdxo70g4.map($_7ntxlzasjdxo70hf.shortcuts, function (shortcut) {
  ...
  var $_55eng7anjdxo70fv = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_bhfge7axjdxo70id.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_bhfge7axjdxo70id.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_bhfge7axjdxo70id.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_bhfge7axjdxo70id.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_7wea45ayjdxo70ih.head(str).bind(function (head) {
      return $_7wea45ayjdxo70ih.tail(str).map(function (tail) {
  ...
  var $_4xqu7xazjdxo70il = { urls: urls };

  var makeLink = $_3v0esraqjdxo70gy.curry($_a6wr2lawjdxo70ia.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_1rk8u3aojdxo70g4.find($_4xqu7xazjdxo70il.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_82bv9bavjdxo70i0.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_1rk8u3aojdxo70g4.filter(keys, $_3v0esraqjdxo70gy.not($_3v0esraqjdxo70gy.curry($_1rk8u3aojdxo70g4.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_1rk8u3aojdxo70g4.map(pluginKeys, function (key) {
  ...
  var $_fi88pfaujdxo70hl = { makeTab: makeTab$1 };
  ...
  var $_xxp1mb0jdxo70in = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_55eng7anjdxo70fv.makeTab(),
          $_fi88pfaujdxo70hl.makeTab(editor)
        ],
        buttons: $_xxp1mb0jdxo70in.makeRow(),
  ...
  var $_cva52uamjdxo70fs = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_cva52uamjdxo70fs.open(editor, pluginUrl));
  };
  var $_dzu3hxaljdxo70fq = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_cva52uamjdxo70fs.open(editor, pluginUrl)
    });
  ...
  var $_2mjoueb2jdxo70iq = { register: register$1 };

  PluginManager.add('help', function (editor, pluginUrl) {
    $_2mjoueb2jdxo70iq.register(editor, pluginUrl);
    $_dzu3hxaljdxo70fq.register(editor, pluginUrl);
