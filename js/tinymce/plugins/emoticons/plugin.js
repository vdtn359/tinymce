...
var emoticons = (function () {
  ...
  var $_84nmxhahjdxo70et = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_84nmxhahjdxo70et.getHtml(pluginUrl);
  ...
  var $_fzghyfagjdxo70ep = { register: register };

  PluginManager.add('emoticons', function (editor, pluginUrl) {
    $_fzghyfagjdxo70ep.register(editor, pluginUrl);
  });
  function Plugin () {
  }
