...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_2iqpm4e5jdxo71be.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_2iqpm4e5jdxo71be.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_2iqpm4e5jdxo71be.getSelectorConverter(editor)) {
      selectorConverter = $_2iqpm4e5jdxo71be.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_2iqpm4e5jdxo71be.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_2iqpm4e5jdxo71be.getCssGroups(editor));
      ...
      if (!$_2iqpm4e5jdxo71be.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      Tools.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_2iqpm4e5jdxo71be.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_92euxde0jdxo71aj.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_1kx43bdzjdxo71ad = { get: get };

  PluginManager.add('importcss', function (editor) {
    $_92euxde0jdxo71aj.setup(editor);
    return $_1kx43bdzjdxo71ad.get(editor);
  });
  function Plugin () {
  }
