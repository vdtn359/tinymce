...
var toc = (function () {
  ...
  var $_197xzaqyjdxo74tz = { create: create };

  var tocId = $_197xzaqyjdxo74tz.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_8h9jpnqxjdxo74tw.getTocClass(editor);
    var headerTag = $_8h9jpnqxjdxo74tw.getTocHeader(editor);
    var selector = generateSelector($_8h9jpnqxjdxo74tw.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_8h9jpnqxjdxo74tw.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_8h9jpnqxjdxo74tw.getTocHeader(editor), I18n.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_9n8c22qtjdxo74tl.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_9n8c22qtjdxo74tl.updateToc(editor);
    });
  };
  var $_enc6x3qsjdxo74te = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_8h9jpnqxjdxo74tw.getTocClass(editor);
  ...
  var $_hk7cyqzjdxo74u4 = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_9n8c22qtjdxo74tl.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_8h9jpnqxjdxo74tw.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_6tgq4fr0jdxo74ua = { register: register$1 };

  PluginManager.add('toc', function (editor) {
    $_enc6x3qsjdxo74te.register(editor);
    $_6tgq4fr0jdxo74ua.register(editor);
    $_hk7cyqzjdxo74u4.setup(editor);
  });
  function Plugin () {
  }
